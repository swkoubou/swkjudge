<?php echo Form::open(array("class"=>"form-horizontal")); ?>
	...
	<fieldset>
		...
		<div class="form-group">
			<?php echo Form::label('Exp', 'exp', array('class'=>'control-label')); ?>

				<?php echo Form::input('exp', Input::post('exp', isset($user) ? $user->exp : ''), array('class' => 'col-md-4 form-control', 'placeholder'=>'Exp')); ?>
